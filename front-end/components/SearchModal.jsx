...
import { Search, X, Loader2, ArrowRight, Calendar } from 'lucide-react';
      ...
      <div className="relative w-full max-w-2xl bg-bg-surface border border-brandborder rounded-2xl shadow-2xl overflow-hidden z-10 animate-in fade-in zoom-in-95 duration-200">
        ...
        <form onSubmit={handleSubmit} className="relative flex items-center px-4 py-3.5 border-b border-brandborder bg-bg-subtle/50">
          ...
          <button
            type="button"
            onClick={onClose}
            className="ml-3 px-2 py-1 text-xs font-semibold rounded bg-bg-subtle text-text-muted border border-brandborder hover:text-text-main transition-colors shrink-0 hidden sm:block cursor-pointer"
          >
            ESC
          </button>
        </form>
